...
if [[ $(flake8 --version) != *"flake8_comprehensions"* ]]; then
    echo "WARNING: Ray uses flake8 with flake8_comprehensions. Might error without it. Install with: pip install flake8-comprehensions"
fi
